...
/*----------------------------------------------------------------*/
function google_map(){
	var map_position = new google.maps.LatLng(42.4450841,-76.4813687);
    var marker_position = new google.maps.LatLng(42.4450841,-76.4813687);
    var map;
    var marker;
...
jQuery(function() {
	...
	jQuery(".portfolio").click(function() {
		jQuery("html, body").animate({ 
			scrollTop: jQuery('#portfolio').offset().top }, 800);
		
		return false;
	});
	jQuery(".contact").click(function() {
		jQuery("html, body").animate({ 
			scrollTop: jQuery('#contact').offset().top }, 800);
